...
// modele-alhee.pptx est également « vivant » : la trame a été enrichie à la main (sections 1.6/1.7
// + bloc analyse énergétique, 7 slides mises à l'échelle 1.5×), ne plus l'écraser par TEMPLATE_B64.
